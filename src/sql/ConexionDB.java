...
public class ConexionDB {
    ...
    private static Connection  cnx = null;
       public static Connection hacerConexion(String servidorIP, String puerto, String usuario, String password) {
          if (cnx == null) {
             try { 
                Class.forName("com.mysql.jdbc.Driver"); //cargar el conector mySQL en las librerias Java
                cnx = DriverManager.getConnection("jdbc:mysql://" + servidorIP + ":" + puerto + "/hotel", usuario, password);
