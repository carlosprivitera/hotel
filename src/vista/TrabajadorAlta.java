...
public class TrabajadorAlta extends JDialog {
    ...
    public TrabajadorAlta() {
        this(null, "", false);
    }

    public TrabajadorAlta(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Alta de trabajadores");
